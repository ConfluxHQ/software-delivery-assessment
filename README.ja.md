...
この手法は、よく知られ実績のある[Spotify Squad Health Check model](https://labs.spotify.com/2014/09/16/squad-health-check-model/)を基にしています。   

この手法は、以下合計6つの観点をカバーしています。     
...
ポジティブな作業環境は以下の状況になります。       
  ...
  - プロセスとプラクティスは、**リリースに向けたソフトウェアの変更フロー**に最適化されている。         
  - ソフトウェアは、1つ１つ分断されたシステムに対して**独立、分離したリリース**ができるように設計および構築されている。     
